...
import GameBase.UI.MainObjects.Basket exposing (eightBaskets)

import Array exposing (Array, fromList)


-- BLOCK 6 : Make result on new place------------------------------------------


-- 6_1 - Delete yellow balls from word, if they exist, else dont change word
...
{-
-- 6_2 - Расположить клубки по цветам радуги путем формирования нового слова
...
{-
-- 6_3 - Перевернуть слово P (например: abb → bba)
