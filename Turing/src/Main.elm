...
transTable = 
  ...
  , { key = (LightGrey, Just Orange), value = (LightGrey, Just Orange, MoveRight)}
  , { key = (LightGrey, Just Yellow), value = (LightGrey, Just Yellow, MoveRight)}
  , { key = (LightGrey, Just Green), value = (LightGrey, Just Green, MoveRight)}
  , { key = (LightGrey, Just Blue), value = (LightGrey, Just Blue, MoveRight)}
  , { key = (LightGrey, Nothing), value = (Grey, Just Red, MoveLeft)}
  , { key = (Grey, Just Red), value = (Grey, Just Red, MoveLeft)}
  , { key = (Grey, Just Orange), value = (Grey, Just Orange, MoveLeft)}
  , { key = (Grey, Just Yellow), value = (Grey, Just Yellow, MoveLeft)}
  , { key = (Grey, Just Green), value = (Grey, Just Green, MoveLeft)}
  , { key = (Grey, Just Blue), value = (Grey, Just Blue, MoveLeft)}
...
main =
  text (runMachine testMachine input)
